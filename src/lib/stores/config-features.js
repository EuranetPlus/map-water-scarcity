export const config = {
	mapTitle: 'map-water-scarcity', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-water-scarcity.vercel.app', // The url provided when deploying the map on Vercel
